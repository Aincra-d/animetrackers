<template>
    <div>
        <div :key="rec.id" v-for="rec in recommendations" class="w-xs-95 w-sm-95 w-md-100 w-lg-100 w-xl-100 text-left text-light d-block my-2 mx-auto mx-lg-0 rec-container rounded">
            ...
            <button :mangaid="rec.id" @click="openModal('mangaInfoModal',rec.id,rec.title)" class="float-right border-0 rounded bg-transparent py-1"><i class="fas fa-info-circle text-light fa-lg"></i></button>
        </div>
    </div>
</template>
