    ...
    <div>
        <div :key="rec.id" v-for="rec in recommendations" class="d-inline-block ml-2 my-1 recommendations-container rounded text-left">
            <div class="position-relative">
                ...
                <button :animeid="rec.id" @click="openModal('animeInfoModal',rec.id,rec.title)" class="position-absolute top-0 right-0 bg-transparent border-0 anime-info py-1"><i class="fas fa-info-circle text-light rounded fa-lg"></i></button>
            </div>
